...
void Scene::restrictScene() {
	_sceneSurface.resetWithoutOwnership(MADS_SCREEN_WIDTH, MADS_SCENE_HEIGHT, MADS_SCREEN_WIDTH,
		(byte *)_vm->_screen.getPixels(), Graphics::PixelFormat::createFormatCLUT8());
}
